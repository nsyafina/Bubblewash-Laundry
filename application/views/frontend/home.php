<!-------------------------------------------------------------- Banner ----------------------------------------------------------->
  ...
  <div class="review">
    ...
    <div class="review-body2">
      <i class="fa-solid fa-quote-left review-icon"></i>
      <p class="review-komen">Contact mau laundry stroller anakku, langsung di pickup hari itu juga. Fast response, fast pickup & delivery. Delivery juga rapih banget dan harga lebih murah dibandingkan tempat lainnya. Puas sekali 😊👍.</p>
  ...
  <div class="google-maps">
    <div class="gmaps1">
      ...
      <div class="text-maps teksmap1">
        ...
        <br>
        | Whatsapp : <a href="https://wa.me/6285779082884?text=Mohon info tentang produk">0857-7908-2884</a> | | Email : adminbubblewashjakarta@gmail.com |</p>
      </div>
