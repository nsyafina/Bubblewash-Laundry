...
<table>
  <tr>
    ...
    <td width="100"><?= $satuan['nama_konsumen']; ?></td>
    <td width="70">Kode Transaksi</td>
    <td><?= $satuan['kode_transaksi']; ?></td>
  </tr>
  <tr>
    <td width="80">Alamat :</td>
    <td width="250"><?= $satuan['alamat_konsumen']; ?></td>
    <td width="80">Tanggal Masuk</td>
    <td><?= $satuan['tgl_masuk']; ?></td>
  </tr>
  <tr>
    <td width="80">Telp :</td>
...
<table class="tabel" width="500">
  ...
  <tr>
    <td><?= $satuan['nama_paket']; ?></td>
    <td><?= $satuan['qty']; ?></td>
    <td><?= $satuan['jenis_barang']; ?></td>
    <td>Rp.<?= number_format($satuan['harga_paket'], 0, '.', '.'); ?>,-</td>
    <td>Rp.<?= number_format($satuan['grand_total'], 0, '.', '.'); ?>,-</td>
  </tr>
  <tr>
    <td colspan="4" style="text-align: right; font-weight: bold; font-size: 14px; padding-right: 7px;">Grand Total</td>
